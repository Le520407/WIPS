    ...
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-green-400 via-blue-500 to-purple-600 p-4">
      <div className="w-full max-w-md p-8 bg-white rounded-2xl shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          {/* WhatsApp Business Embedded Signup/Login */}
          <button
            onClick={handleEmbeddedSignup}
            disabled={loading}
            className="w-full flex items-center justify-center px-6 py-4 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl hover:from-green-600 hover:to-green-700 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {loading ? (
              <>
              ...
              <>
                ...
                <div className="text-left">
                  <div className="font-semibold text-lg">Continue with WhatsApp Business</div>
                  <div className="text-xs text-green-100">Sign up or log in via Meta</div>
                </div>
              </>
            )}
          </button>
